...
const javascriptLanguage = language.LezerLanguage.define({
    parser: lezerJavascript.parser.configure({
        props: [
            ...
            highlight.styleTags({
                ...
                PropertyNameDefinition: highlight.tags.definition(highlight.tags.propertyName),
                ...
                "abstract global privacy readonly": highlight.tags.modifier,
                "is keyof unique infer": highlight.tags.operatorKeyword,
                JSXAttributeValue: highlight.tags.string,
                ...
                "JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName": highlight.tags.propertyName
            })
        ]
    }),
    languageData: {
